...
public enum PeakHoldCurrentDemandRegister implements Register {
    ...
    PeakHoldCurrentDemandRegister(final int registerValue, final RegisterScaling registerScaling) {
