...
public enum CombinedModbusRegisters implements CombinedEnergyRegister {
    ...
    CombinedModbusRegisters(final ModbusRegister escaleHighWord, final ModbusRegister escaleLowWord) {
