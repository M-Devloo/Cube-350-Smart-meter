...
public enum TotalHarmonicDistortionModbusRegister implements ModbusRegister {
    ...
    TotalHarmonicDistortionModbusRegister(final int registerValue, final RegisterScaling registerScaling) {
